    ...
    <div className="relative min-h-screen flex items-center justify-center bg-zinc-950 overflow-hidden font-sans">
      ...
      <div className="relative w-full max-w-md mx-4 animate-in fade-in zoom-in duration-700">
        <div className="mb-10 text-center space-y-2">
          ...
          <p className="text-zinc-500 font-medium">Your journey begins here.</p>
        </div>
        ...
        <div className="backdrop-blur-xl bg-white/[0.03] border border-white/[0.08] p-8 rounded-3xl shadow-2xl">
          ...
          {error && (
            <div className="bg-red-500/10 text-red-400 px-4 py-3 rounded-xl mb-6 text-xs font-semibold border border-red-500/20 text-center">
              {error}
            </div>
          )}
        ...
        <p className="mt-8 text-center text-sm text-zinc-400">
          Already part of us?{' '}
          <Link to="/login" className="text-blue-400 hover:text-blue-300 font-bold decoration-2 underline-offset-4 hover:underline transition-all">
            Return to glory
          </Link>
        </p>
      </div>
